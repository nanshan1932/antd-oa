...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '字典维护', icon: 'table', permission: [ 'table' ] },
        children: [
          {
            path: '/dictionary/DictionaryList/:pageNo([1-9]\\d*)?',
            name: 'DictionaryListWrapper',
            hideChildrenInMenu: true, // 强制显示 MenuItem 而不是 SubMenu
            component: () => import('@/views/dictionary/DictionaryList'),
            meta: { title: '字典列表', keepAlive: true, permission: [ 'table' ] }
          }
        ]
      },
